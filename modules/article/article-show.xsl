...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:portal="http://www.enonic.com/cms/xslt/portal" xmlns:util="enonic:utilities" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="content">
    <xsl:if test="/result/contents/relatedcontents/content[@key = current()/contentdata/image[position() &gt;= 0]/image/@key]">
			<div id="carousel">
      <xsl:for-each select="contentdata/image[position() &gt;= 0 and image/@key = /result/contents/relatedcontents/content/@key]">
        <div class="image">
