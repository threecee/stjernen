...
<xsl:stylesheet exclude-result-prefixes="saxon xs portal" version="2.0" xmlns:portal="http://www.enonic.com/cms/xslt/portal" xmlns:saxon="http://saxon.sf.net/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  -->
  <xsl:param name="channelTitle" select="'Stjernen'"/>
  <xsl:param name="channelLink" select="'http://stjernen.no'"/>
  <xsl:param name="channelDescription" select="'Siste nyheter fra Stjernen'"/>
  <xsl:param name="channelLanguage" select="'NO-no'"/>
  <xsl:param name="channelManagingEditor" select="'Stjernens redaktør'"/>
  <xsl:param name="channelWebMaster" select="'webmaster@stjernen.no'"/>
  <xsl:param name="channelImageUrl" select="'http://stjernen.no/images/logo_rss.gif'"/>
  <xsl:param name="channelImageTitle" select="'Stjernen'"/>
  ...
  <xsl:param name="baseUrl" select="'http://stjernen.no/'"/>
